...
public class Armor extends Item {
    ...
    public Armor(int value, int id, int meleeDefense, int rangeDefense, int spellDefense) {
        super(value, id, 1);
    ...
    @Override
    public Item clone() {
        Item armor = new Armor(getValue(), getId(), getMeleeDefense(), getRangeDefense(), getSpellDefense());
        return armor;
    }
